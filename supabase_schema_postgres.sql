...
CREATE TABLE bus_settings (id INTEGER PRIMARY KEY, last_update TEXT);
...
CREATE TABLE food_review_votes (id SERIAL PRIMARY KEY, review_id INTEGER NOT NULL, vendor_id INTEGER NOT NULL, user_id INTEGER NOT NULL, vote_type TEXT NOT NULL, created_at TIMESTAMPTZ DEFAULT NOW(), UNIQUE(review_id, user_id));
...
CREATE TABLE resource_likes (id SERIAL PRIMARY KEY, resource_id INTEGER NOT NULL, user_id INTEGER NOT NULL, created_at TIMESTAMPTZ DEFAULT NOW(), UNIQUE(resource_id, user_id));
